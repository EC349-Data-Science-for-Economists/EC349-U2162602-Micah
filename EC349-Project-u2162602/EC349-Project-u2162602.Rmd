...
```{r}
load("~/Desktop/RStudio/EC349-Project-Micah/Small Datasets/yelp_review_small.Rda")
load("~/Desktop/RStudio/EC349-Project-Micah/Small Datasets/yelp_user_small.Rda")
business_data <- stream_in(file("~/Desktop/RStudio/EC349-Project-Micah/Small Datasets/yelp_academic_dataset_business.json")) 
```
...
A 58.1% accuracy, which is the total number of correct predictions divided by the total number of predictions, suggests the model performs reasonably well and has learned patterns in the data.
